...
export class SheetsService {
  ...
  // 1. Users Operations
  public async addUser(user: UserRow): Promise<void> {
  ...
  // 3. Siswa Operations
  public async addSiswa(siswa: SiswaRow): Promise<void> {
  ...
  public async createTransaksi(transaksi: TransaksiRow, operatorId: string): Promise<void> {
  ...
  public async cancelTransaksi(transaksiId: string, operatorId: string, alasan: string): Promise<void> {
